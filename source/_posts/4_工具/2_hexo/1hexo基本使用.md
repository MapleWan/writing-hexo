...
图片资源统一存储在 `source/images`下

- `_config.yml`
```yaml
title: MapleWan's Blog
subtitle: 'Go ahead'
description: '心平气静'
keywords: "Learning, Share, JavaScript, Python, Algorithm"
author: Maple Wan
language: zh-CN    # 以上是基本信息的配置
timezone: ''
url: "http://example.com"
permalink: '_posts/:title/'       # 这个是配置文章的访问路径  这里主要是为了适配obsidian中的路径访问
...
i18n_dir: ':lang'
skip_render: template/**   # 由于使用了obsidian，这里使用了模板文件，我需要忽略这一部分模板文件
...
ignore: null
theme: next
deploy:       # 这里使用github进行部署
  type: git
  repo: https://github.com/MapleWan/MapleWan.github.io
# hexo-generator-searchdb #本地搜索的启用
search:       
  path: search.xml
  field: post
  format: html
  limit: 10
# hexo-symbols-count-time  # 统计全站字数与大概阅读时间
symbols_count_time:
  symbols: true
  time: true
  total_symbols: true
...
favicon:
  small: /images/maple.png
  medium: /images/maple2.png
  apple_touch_icon: /images/maple3.png
  safari_pinned_tab: /images/maple4.svg
...
# 这里是启用  关于、标签、分类 三个页面   需要使用 hexo new page home 命令生成对应的page页面，同时需要在生成的page页面 加入 type: "tags"     这样页面中才会出现文章中配置的 categories或tags
menu:
...
social:     # 个人联系方式配置  有图标
  GitHub: https://github.com/MapleWan || fab fa-github
  E-Mail: mailto:1041709112@qq.com || fa fa-envelope
...
github_banner:
  enable: false
  permalink: https://github.com/MapleWan
